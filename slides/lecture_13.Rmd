...
.large[
**Full model:** $\log \left( \dfrac{p_i}{1 - p_i} \right) = \beta_0 + \beta_1 Age_i + \beta_2 Sex_i + \\ \hspace{2cm} \beta_3 Age_i \cdot Sex_i + \beta_4 \log(Fare_i + 1)$
...
$$G = 2 \ell(\widehat{\beta}) - 2 \ell(\widehat{\beta}^0) = 171.76$$

.question[
If the reduced model is correct, how unusual is $G = 171.76$?
]
]
